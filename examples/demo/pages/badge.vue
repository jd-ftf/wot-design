  ...
  <div class="page-badge">
    <demo-block title="展示消息数量">
      <wd-badge :value="12" class="item">
        <wd-button size="small" plain type="info">评论</wd-button>
      </wd-badge>
      <wd-badge :value="3" class="item" bg-color="pink">
        <wd-button size="small" plain type="info">回复</wd-button>
      </wd-badge>
    ...
    <demo-block title="点状类型">
      ...
      <wd-badge is-dot class="item">
        <wd-button class="share-button" plain type="info">数据查询</wd-button>
      </wd-badge>
    </demo-block>
  </div>
</template>

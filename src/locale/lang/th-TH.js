export default {
  wd: {
    ...
    calendarView: {
      ...
      rangePrompt: 'จำนวนวันที่เลือกต้องไม่เกิน {maxRange} วัน',
      rangePromptWeek: 'จำนวนสัปดาห์ที่เลือกต้องไม่เกิน {maxRange} สัปดาห์',
      rangePromptMonth: 'เดือนที่เลือกต้องไม่เกิน {maxRange} เดือน',
      monthTitle: 'YYYY-MM',
      yearTitle: 'YYYY',
      month: 'MM',
      hour: '{value}',
    ...
    pullRefresh: {
      topPull: 'ลากลงเพื่อรีเฟรช',
      topDrop: 'ปล่อยเพื่อรีเฟรช',
      topLoading: 'กำลังรีเฟรช.. รอสักครู่..'
    },
    search: {
      search: 'ค้นหา ',
      cancel: 'ยกเลิก'
